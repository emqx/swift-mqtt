...
public class DecodeConnAck: NSObject {
    ...
    public func properties(connackData: [UInt8]){
        ...
        if (protocolVersion == "5.0"){
            ...
            while index - occupyIndex < propertyLength! {
                ...
                guard let propertyName = Property(rawValue: UInt8(propertyNameByte)) else {
                    break
                }

                switch propertyName.rawValue {

                case Property.sessionExpiryInterval.rawValue:
                ...
                case Property.receiveMaximum.rawValue:
                ...
                case Property.maximumQoS.rawValue:
                ...
                case Property.retainAvailable.rawValue:
                    if index > connackData.count  {
                        break
                    }
                    if connackData[index] & 0x01 > 0 {
                ...
                case Property.maximumPacketSize.rawValue:

                    let comRes = integerCompute(data: connackData, formatType: formatInt.formatUint32.rawValue, offset: index)
                    maximumPacketSize = UInt32(comRes!.res)
                    index = comRes!.newOffset

                case Property.assignedClientIdentifier.rawValue:
                ...
                case Property.topicAliasMaximum.rawValue:

                    let comRes = integerCompute(data: connackData, formatType: formatInt.formatUint16.rawValue, offset: index)
                    topicAliasMaximum = UInt16(comRes!.res)
                    index = comRes!.newOffset

                case Property.reasonString.rawValue:
                    guard let result = unsignedByteToString(data: connackData, offset: index) else {
                        break
                    }
                ...
                case Property.userProperty.rawValue:
                    var key:String?
                    var value:String?
                ...
                case Property.wildcardSubscriptionAvailable.rawValue:
                    if index > connackData.count  {
                        break
                    }
                    if connackData[index] & 0x01 > 0 {
                ...
                case Property.subscriptionIdentifiersAvailable.rawValue:
                    if index > connackData.count  {
                        break
                    }
                    if connackData[index] & 0x01 > 0 {
                ...
                case Property.sharedSubscriptionAvailable.rawValue:
                    if index > connackData.count  {
                        break
                    }
                    if connackData[index] & 0x01 > 0 {
                ...
                case Property.serverKeepAlive.rawValue:

                    let comRes = integerCompute(data: connackData, formatType: formatInt.formatUint16.rawValue, offset: index)
                    serverKeepAlive = UInt16(comRes!.res)
                    index = comRes!.newOffset

                case Property.responseInformation.rawValue:
                    guard let valRes = unsignedByteToString(data: connackData, offset: index) else {
                        break
                    }
                ...
                case Property.serverReference.rawValue:
                    guard let valRes = unsignedByteToString(data: connackData, offset: index) else {
                        break
                    }
                ...
                case Property.authenticationMethod.rawValue:
                    guard let valRes = unsignedByteToString(data: connackData, offset: index) else {
                        break
                    }
                ...
                case Property.authenticationData.rawValue:
