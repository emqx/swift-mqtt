...
struct Pubcomp: Frame {
    ...
    public var pubCompProperties: DecodePubComp?
    ...
    ///MQTT 5.0
    init(msgid: UInt16,  reasonCode: PubCompReasonCode) {
        self.msgid = msgid
...
extension Pubcomp: InitialWithBytes {
