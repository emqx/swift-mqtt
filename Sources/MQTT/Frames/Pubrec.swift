...
struct Pubrec: Frame {
    ...
    public var pubRecProperties: DecodePubRec?
    ...
    ///MQTT 5.0
    init(msgid: UInt16, reasonCode: PubRecReasonCode) {
        self.msgid = msgid
...
extension Pubrec: InitialWithBytes {
