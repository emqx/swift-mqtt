...
struct Unsub: Frame {
    ...
    var packetFixedHeaderType: UInt8 = UInt8(FrameType.unsub.rawValue + 2)
    ...
    ///MQTT 5.0
    init(msgid: UInt16, topics: [Subscription]) {
        self.msgid = msgid
...
extension Unsub {
    ...
    func fixedHeader() -> [UInt8] {
        ...
        var header = [UInt8]()
        header += [FrameType.unsub.rawValue]
...
extension Unsub: CustomStringConvertible {
