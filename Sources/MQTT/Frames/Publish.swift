...
struct Publish: Frame {
    ...
    public var publishProperties: PublishProperties?
    public var publishRecProperties: DecodePublish?

    var packetFixedHeaderType: UInt8 = FrameType.pub.rawValue
...
extension Publish: InitialWithBytes {
    
    init?(packetFixedHeaderType: UInt8, bytes: [UInt8]) {
        
        guard packetFixedHeaderType & 0xF0 == FrameType.pub.rawValue else {
            return nil
        }
...
extension Publish: CustomStringConvertible {
