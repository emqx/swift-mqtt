...
/// MQTT CONNECT Frame
struct Connect: Frame {

    var packetFixedHeaderType: UInt8 = FrameType.conn.rawValue
    ...
    //3.1.2.5 Will Flag
    var willMsg: MQTT.Message?
    var willMsg5: MQTT.Message?
    //3.1.2.6 Will QoS
    var willQoS: UInt8?
    //3.1.2.7 Will Retain
...
extension Connect {
    ...
    func fixedHeader() -> [UInt8] {
        ...
        var header = [UInt8]()
        header += [FrameType.conn.rawValue]
...
extension Connect: CustomStringConvertible {
