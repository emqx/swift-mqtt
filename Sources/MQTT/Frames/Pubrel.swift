...
struct Pubrel: Frame {
    ...
    public var reasonCode: PubRelReasonCode = .success


    //3.6.2.2 PUBREL Properties
    public var pubRelProperties: DecodePubRel?
...
extension Pubrel: InitialWithBytes {
